              ...
              Container(
                child: ElevatedButton(
                  onPressed: () {
                    setState(() {
                      isCalculated = true;
                      String cleanValue = no2Controller.text.replaceAll(',', '');
                      double? parsedValue = double.tryParse(cleanValue);
                      if (parsedValue == null) {

                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Press = first to evaluate the expression'),
                      ...
                      isCalculated = true;
                      divoperation = widget.rates[dropdownToValue] / widget.rates[dropdownValue];
                                            ...
                                            onTap: (){
                                              ...
                                              setState(() {
                                                ...
                                                if (numArray[index] == 'C') {
                                                  ...
                                                  no2Controller.text = a.toString().replaceAll(',', '');

                                                  expression = a.toString().replaceAll(',', '');
                                                  // box.put({
                                                  //
                                                  // })
